...
android {
    ...
    defaultConfig {
        ...
        minSdk = 23
        targetSdk = 34
        versionCode = 209030002
        versionName = "2.09.03-alpha02"      // keep -release as a suffix also for release, build flavor adds the suffix e.g. .gplay (e.g. 1.00.00-rc0.gplay)
