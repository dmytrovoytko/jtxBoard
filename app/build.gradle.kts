...
android {
    ...
    defaultConfig {
        ...
        minSdk = 23
        targetSdk = 35
        versionCode = 211000002
        versionName = "2.11.00-alpha02"      // keep -release as a suffix also for release, build flavor adds the suffix e.g. .gplay (e.g. 1.00.00-rc0.gplay)
