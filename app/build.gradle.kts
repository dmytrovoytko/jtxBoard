...
android {
    ...
    defaultConfig {
        ...
        minSdk = 23
        targetSdk = 34
        versionCode = 209020003
        versionName = "2.09.02-beta02"      // keep -release as a suffix also for release, build flavor adds the suffix e.g. .gplay (e.g. 1.00.00-rc0.gplay)
