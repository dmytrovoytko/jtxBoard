...
android {
    ...
    defaultConfig {
        ...
        minSdk = 23
        targetSdk = 35
        versionCode = 210010008
        versionName = "2.10.01-alpha08"      // keep -release as a suffix also for release, build flavor adds the suffix e.g. .gplay (e.g. 1.00.00-rc0.gplay)
